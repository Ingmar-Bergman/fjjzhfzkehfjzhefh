...
parser.add_argument('--epochs-autoencoder', type=int, default=185, help="Number of training epochs for the autoencoder (default: 200)")
...
autoencoder = VariationalAutoEncoder(args.spectral_emb_dim+1, args.hidden_dim_encoder, args.hidden_dim_decoder, args.latent_dim, args.n_layers_encoder, args.n_layers_decoder, args.n_max_nodes, dropout=0.5).to(device)
...
optimizer = SAM(autoencoder.parameters(), base_optimizer, adaptive=True, lr = args.lr,rho=0.5) #0.019 pour rho = 0.1
